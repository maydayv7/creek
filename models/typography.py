"""
Typography
Original file: https://colab.research.google.com/drive/11sdpsNaYwetetOotIX3GKtxgaQOt7S0Y
"""
...
if os.path.exists(FONT_DB_PKL) and os.path.exists(MODEL_JSON):
    ...
    encoder = Model(
        inputs=fannet_model.input, outputs=fannet_model.get_layer("dense_1").output
    )
    ...
    print(
        "Files not found. Please upload test image.png, fannet.json, fannet_weights.h5, and font_database.pkl"
    )
